...
func TestContinuitySQLiteContractHasExactSourceAndAPI(t *testing.T) {
	...
	wantExports := []string{
		"NewHandoffRehearsalFact",
		"NewJournalRehearsalFact",
		"NewProjectRehearsalFact",
		"NewWrapRehearsalFact",
		"OpaqueSyncFrame",
		...
		"Store.CurrentSyncPruneWitnessAuthorityUnderBinding",
		"Store.CurrentSyncRecoveryPruneCandidate",
		"Store.CurrentTerminalCandidate",
		"Store.DeriveContext",
		"Store.DetachExternalReference",
		"Store.DiscardStagedSync",
		"Store.DiscardSyncAuthorityCandidate",
		"Store.DiscardSyncRecoveryPruneCandidate",
		"Store.DiscardTerminalCandidate",
		"Store.DismissSpark",
		"Store.ExportFact",
		"Store.ImportRehearsalFacts",
		...
		"Store.Snapshot",
		"Store.StageSyncPage",
		"Store.StageSyncPageUnderAuthority",
		"Store.StageVerifiedRecoveryTerminalCandidateChunk",
		"Store.StageVerifiedSyncAuthorityCandidatePage",
		"Store.StageVerifiedSyncRecoveryPruneCandidatePage",
		"Store.StageVerifiedTerminalCandidateChunk",
		"Store.StartExploration",
		"Store.SupersedeDecision",
		"Store.SyncRecoveryPruneTargetByArrival",
		"Store.VerifySyncRecoveryPruneCandidatePageRecords",
		"Store.VerifySyncRecoveryPrunePreflight",
		...
		"SyncAuthorityCandidate.CandidateID",
		"SyncAuthorityCandidate.Checkpoint",
		"SyncAuthorityCandidate.EnvironmentCount",
		"SyncAuthorityCandidate.PageCount",
		"SyncAuthorityCandidate.ProjectID",
		"SyncAuthorityCandidate.Ready",
		"SyncAuthorityCandidate.RollingEnvironmentDigest",
		"SyncAuthorityCandidate.Snapshot",
		"SyncAuthorityCandidate.ThroughEnvironmentID",
		"SyncAuthorityCandidateCheckpoint",
		"SyncAuthorityCandidateCheckpoint.AuthorityDigest",
		"SyncAuthorityCandidateCheckpoint.CandidateID",
		"SyncAuthorityCandidateCheckpoint.EnvironmentCount",
		"SyncAuthorityCandidateCheckpoint.PageCount",
		...
		"SyncAuthoritySnapshot.BaseAuthorityDigestVersion",
		"SyncAuthoritySnapshot.ChannelID",
		"SyncAuthoritySnapshot.InventoryArrivalHead",
		"SyncAuthoritySnapshot.MembershipGeneration",
		"SyncAuthoritySnapshot.RelayGeneration",
		"SyncChannelID",
		...
		"SyncPruneWitnessAuthority",
		"SyncPruneWitnessAuthority.Binding",
		"SyncPruneWitnessAuthority.Environments",
		"SyncPruneWitnessAuthority.MembershipGeneration",
		"SyncRecoveryPruneCandidate",
		"SyncRecoveryPruneCandidate.CandidateID",
		"SyncRecoveryPruneCandidate.Checkpoint",
		"SyncRecoveryPruneCandidate.InventoryDigest",
		"SyncRecoveryPruneCandidate.LastMembershipGeneration",
		"SyncRecoveryPruneCandidate.PageCount",
		"SyncRecoveryPruneCandidate.ProjectID",
		"SyncRecoveryPruneCandidate.PruneCount",
		"SyncRecoveryPruneCandidate.Ready",
		"SyncRecoveryPruneCandidate.RollingInventoryDigest",
		"SyncRecoveryPruneCandidate.Snapshot",
		"SyncRecoveryPruneCandidate.TargetCount",
		"SyncRecoveryPruneCandidate.ThroughPruneSequence",
		"SyncRecoveryPruneCandidateCheckpoint",
		"SyncRecoveryPruneCandidateCheckpoint.CandidateID",
		"SyncRecoveryPruneCandidateCheckpoint.InventoryDigest",
		"SyncRecoveryPruneCandidateCheckpoint.LastMembershipGeneration",
		"SyncRecoveryPruneCandidateCheckpoint.PageCount",
		"SyncRecoveryPruneCandidateCheckpoint.PruneCount",
		"SyncRecoveryPruneCandidateCheckpoint.Ready",
		"SyncRecoveryPruneCandidateCheckpoint.RollingInventoryDigest",
		"SyncRecoveryPruneCandidateCheckpoint.TargetCount",
		"SyncRecoveryPruneCandidateCheckpoint.ThroughPruneSequence",
		"SyncRecoveryPruneCandidatePage",
		"SyncRecoveryPruneCandidatePage.AfterPruneSequence",
		"SyncRecoveryPruneCandidatePage.GoString",
		"SyncRecoveryPruneCandidatePage.InventoryDigest",
		"SyncRecoveryPruneCandidatePage.LastMembershipGeneration",
		"SyncRecoveryPruneCandidatePage.More",
		"SyncRecoveryPruneCandidatePage.PagePruneCount",
		"SyncRecoveryPruneCandidatePage.PageTargetCount",
		"SyncRecoveryPruneCandidatePage.Records",
		"SyncRecoveryPruneCandidatePage.ResultingRollingDigest",
		"SyncRecoveryPruneCandidatePage.String",
		"SyncRecoveryPruneInventoryDigest",
		"SyncRecoveryPruneRollingDigest",
		"SyncRecoveryPruneSnapshot",
		"SyncRecoveryPruneSnapshot.Authority",
		"SyncRecoveryPruneSnapshot.PruneHead",
		"SyncRecoveryPruneTargetMatch",
		"SyncRecoveryPruneTargetMatch.FactKind",
		"SyncRecoveryPruneTargetMatch.GoString",
		"SyncRecoveryPruneTargetMatch.HLC",
		"SyncRecoveryPruneTargetMatch.MembershipGeneration",
		"SyncRecoveryPruneTargetMatch.PruneCertificateID",
		"SyncRecoveryPruneTargetMatch.PruneID",
		"SyncRecoveryPruneTargetMatch.Reference",
		"SyncRecoveryPruneTargetMatch.String",
		"SyncRelayWatermark",
		"SyncRelayWatermark.AdminPublicKey",
		"SyncRelayWatermark.ChannelID",
		"SyncRelayWatermark.MembershipGeneration",
		"SyncRelayWatermark.ProjectID",
		"SyncRelayWatermark.RelayGeneration",
		"SyncRelayWatermark.RelayHead",
		"TerminalCandidate",
		...
		"VerifiedSyncRecoveryPruneRecord.GoString",
		"VerifiedSyncRecoveryPruneRecord.MembershipGeneration",
		"VerifiedSyncRecoveryPruneRecord.PruneCertificateID",
		"VerifiedSyncRecoveryPruneRecord.PruneID",
		"VerifiedSyncRecoveryPruneRecord.PruneSequence",
		"VerifiedSyncRecoveryPruneRecord.String",
		"VerifiedSyncRecoveryPruneRecord.Targets",
		"VerifiedSyncRecoveryPruneTarget",
		"VerifiedSyncRecoveryPruneTarget.FactKind",
		"VerifiedSyncRecoveryPruneTarget.GoString",
		"VerifiedSyncRecoveryPruneTarget.HLC",
		"VerifiedSyncRecoveryPruneTarget.Reference",
		"VerifiedSyncRecoveryPruneTarget.String",
		"VerifiedTerminalCandidateFrame",
		"VerifiedTerminalCandidateFrame.GoString",
		"VerifiedTerminalCandidateFrame.Inbox",
		"VerifiedTerminalCandidateFrame.Pruned",
		"VerifiedTerminalCandidateFrame.Sealed",
		"VerifiedTerminalCandidateFrame.String",
		"VerifiedTerminalPrunedFrame",
		"VerifiedTerminalPrunedFrame.FactKind",
		"VerifiedTerminalPrunedFrame.GoString",
		"VerifiedTerminalPrunedFrame.HLC",
		"VerifiedTerminalPrunedFrame.PruneCertificateID",
		"VerifiedTerminalPrunedFrame.PruneID",
		"VerifiedTerminalPrunedFrame.Reference",
		"VerifiedTerminalPrunedFrame.String",
	}
...
func TestContinuitySQLiteContractPinsDriverBoundary(t *testing.T) {
	...
	wantImports := map[string][]string{
		...
		"legacy_scratchpad_v1.go": {"github.com/levifig/loaf/vnext/continuity"},
		...
		"rehearsal.go": {"context", "database/sql", "errors", "fmt", "github.com/levifig/loaf/vnext/continuity"},
		"relay_watermark.go": {
			"bytes",
			"context",
			"database/sql",
		...
		"relay_watermark_migration.go": {"bytes", "database/sql", "fmt", "sort"},
...
func TestContinuitySQLiteContractRejectsRawAndExternalAuthoritySurfaces(t *testing.T) {
	...
	for _, entry := range entries {
		...
		if strings.Contains(upper, "DELETE FROM CONTINUITY_FACTS") {
...
func TestContinuitySQLiteContractPinsExactSchema(t *testing.T) {
	...
	if applicationID != 1280267825 || userVersion != 11 {
	...
	if line != "vnext" || version != 11 || checksum != "1a1a1f0f7db82e2a6a5d7e00c0e65bd4ea854a0ea68f5c682895c81239d90166" {
	...
	wantObjects := []objectDigest{
		...
		{kind: "index", name: "ux_continuity_sync_authority_candidates_active_project", table: "continuity_sync_authority_candidates", digest: "4546056e36b488130357a1fc2c5e28bc9bec6fbdcf8e7248dac15aaa15f27357"},
		...
		{kind: "index", name: "ux_continuity_sync_recovery_prune_candidates_identity", table: "continuity_sync_recovery_prune_candidates", digest: "dfdb222cab43f95cde4b294e0b2de6d778f145e7e3de425210373a5485414af0"},
		...
		{kind: "table", name: "continuity_schema", table: "continuity_schema", digest: "5a7892615f334bec0ec63b120ee6d96a9bd7b5c10eb2eddb134883bd7b72bcde"},
		...
		{kind: "table", name: "continuity_sync_recovery_prune_candidates", table: "continuity_sync_recovery_prune_candidates", digest: "65efe41f7e9be9d21cef07e4233fbdd5c0d67dea2655288fd86a90853c252a81"},
		{kind: "table", name: "continuity_sync_recovery_prune_records", table: "continuity_sync_recovery_prune_records", digest: "f431128fbb5edea82e5aeb20033db1c2c8cbaabb096c2097d87ee78418c76048"},
		{kind: "table", name: "continuity_sync_recovery_prune_targets", table: "continuity_sync_recovery_prune_targets", digest: "28b198503dc5a8f619bae7f320d5eb14af154cd0124d4370409dbb4f8d5e0fba"},
		{kind: "table", name: "continuity_sync_relay_watermarks", table: "continuity_sync_relay_watermarks", digest: "7c89163ca98f804b110eab7b0bbcdc0c4efde8081ae73b6d5102794e19941790"},
		...
		{kind: "table", name: "continuity_sync_tombstones", table: "continuity_sync_tombstones", digest: "dc4433c4b482bfd59d35b81069aa7808a35902701c58bacf65cd2e456ef45b15"},
	...
	wantColumns := map[string][]columnSpec{
		...
		"continuity_sync_relay_watermarks": {
			{name: "project_id", dataType: "TEXT", notNull: 1, primaryKey: 1},
			{name: "channel_id", dataType: "BLOB", notNull: 1, primaryKey: 2},
			{name: "relay_generation", dataType: "BLOB", notNull: 1, primaryKey: 3},
			{name: "admin_public_key", dataType: "BLOB", notNull: 1},
			{name: "membership_generation", dataType: "INTEGER", notNull: 1},
			{name: "relay_head", dataType: "INTEGER", notNull: 1},
			{name: "membership_floor_known", dataType: "INTEGER", notNull: 1},
		},
	}
	...
	for _, tableName := range []string{"continuity_schema", "continuity_facts", "continuity_sync_relay_watermarks"} {
...
func TestContinuitySQLiteContractPinsStoreRepresentation(t *testing.T) {
	...
	watermarkType := reflect.TypeOf(continuitysqlite.SyncRelayWatermark{})
	gotWatermarkFields := make([]fieldSpec, 0, watermarkType.NumField())
	for index := 0; index < watermarkType.NumField(); index++ {
		field := watermarkType.Field(index)
		gotWatermarkFields = append(gotWatermarkFields, fieldSpec{
			name:      field.Name,
			typeName:  field.Type.String(),
			exported:  field.IsExported(),
			anonymous: field.Anonymous,
	...
	wantWatermarkFields := []fieldSpec{
		{name: "ProjectID", typeName: "continuity.ProjectID", exported: true},
		{name: "ChannelID", typeName: "sqlite.SyncChannelID", exported: true},
		{name: "RelayGeneration", typeName: "[32]uint8", exported: true},
		{name: "AdminPublicKey", typeName: "[32]uint8", exported: true},
		{name: "MembershipGeneration", typeName: "uint32", exported: true},
		{name: "RelayHead", typeName: "int64", exported: true},
	}
	if !reflect.DeepEqual(gotWatermarkFields, wantWatermarkFields) {
		t.Fatalf("SyncRelayWatermark fields = %#v, want %#v", gotWatermarkFields, wantWatermarkFields)
	}
	...
	wantMethods := map[string]string{
		...
		"CurrentSyncPruneWitnessAuthorityUnderBinding":     "func(*sqlite.Store, context.Context, continuity.ProjectID, sqlite.SyncAuthorityBinding, uint32) (sqlite.SyncPruneWitnessAuthority, error)",
		"CurrentSyncRecoveryPruneCandidate":                "func(*sqlite.Store, context.Context, continuity.ProjectID) (sqlite.SyncRecoveryPruneCandidate, bool, error)",
		...
		"DiscardSyncRecoveryPruneCandidate":                "func(*sqlite.Store, context.Context, continuity.ProjectID, sqlite.SyncRecoveryPruneCandidateCheckpoint) error",
		...
		"ImportRehearsalFacts":                             "func(*sqlite.Store, context.Context, continuity.ProjectID, []sqlite.RehearsalFact, sqlite.RehearsalSnapshotVerifier) (continuity.Snapshot, error)",
		...
		"StageSyncPageUnderAuthority":                      "func(*sqlite.Store, context.Context, continuity.ProjectID, sqlite.SyncAuthorityBinding, int64, int64, []sqlite.OpaqueSyncFrame) (sqlite.SyncProgress, error)",
		"StageVerifiedRecoveryTerminalCandidateChunk":      "func(*sqlite.Store, context.Context, continuity.ProjectID, sqlite.SyncAuthorityBinding, sqlite.SyncRecoveryPruneCandidate, []sqlite.VerifiedTerminalCandidateFrame, int64, int64) (sqlite.TerminalCandidate, error)",
		...
		"StageVerifiedSyncRecoveryPruneCandidatePage":      "func(*sqlite.Store, context.Context, continuity.ProjectID, sqlite.SyncRecoveryPruneSnapshot, *sqlite.SyncRecoveryPruneCandidateCheckpoint, sqlite.SyncRecoveryPruneCandidatePage) (sqlite.SyncRecoveryPruneCandidate, error)",
		"VerifySyncRecoveryPruneCandidatePageRecords":      "func(*sqlite.Store, context.Context, continuity.ProjectID, sqlite.SyncRecoveryPruneSnapshot, sqlite.SyncRecoveryPruneCandidateCheckpoint, sqlite.SyncRecoveryPruneCandidatePage) error",
		"VerifySyncRecoveryPrunePreflight":                 "func(*sqlite.Store, context.Context, continuity.ProjectID, sqlite.SyncAuthorityBinding, *sqlite.SyncRecoveryPruneCandidate) error",
		...
		"SyncRecoveryPruneTargetByArrival":                 "func(*sqlite.Store, context.Context, continuity.ProjectID, sqlite.SyncRecoveryPruneCandidate, int64) (sqlite.SyncRecoveryPruneTargetMatch, bool, error)",
...
func TestContinuitySQLiteContractMatchesEveryCatalogFactToExactlyOneSubjectKind(t *testing.T) {
	...
	if len(definitions) != 26 {
		t.Fatalf("fact catalog has %d definitions, want 26", len(definitions))
	}
