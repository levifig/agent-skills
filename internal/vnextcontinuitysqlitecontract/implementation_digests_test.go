...
func expectedPersistenceSourceDigests() map[string]string {
	return map[string]string{
		...
		"authority.go":                     "ac4a86f28d4028986ba71b8069237654172df6834c956e7854f97bae2e5b538e",
...
func expectedPersistenceFunctionDigests() map[string]map[string]string {
	return map[string]map[string]string{
		...
		"authority.go": {
			"Store.CurrentSyncAuthority":            "7ea53de591bb332ba303128bfdb92320fa2264368d7ad7ced8929b6032779a2e",
			"Store.CurrentSyncAuthorityBinding":     "afb642d962fd466e5ad601023db4ef9bcc7f8ed77fb1d514a5493acb7fdbed5d",
			"Store.InstallVerifiedSyncAuthority":    "68d96e69a35ea779fea5e06450f4f3fe42d329cb14bcf0cd9997a2b001ac232b",
