...
func expectedPersistenceFunctionDigests() map[string]map[string]string {
	return map[string]map[string]string{
		...
		"authority_recovery_successor.go": {
			...
			"Store.AppendVerifiedSyncAuthorityRecoverySuccessorPage": "a430694e1b4a29c5ab15233a49d3e0590e981c192afb7c4728f0cfe92fb8c7f5",
			...
			"requireRetainedSyncAuthorityRecoveryWatermarkV1":        "93c0d80db79117111c07dc9e1d6bbcf053bbead48fc16d4d3e83cc407f1c9f43",
