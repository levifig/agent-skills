...
func TestContinuityDomainContractHasExactSourceAndExports(t *testing.T) {
	...
	wantProduction := []string{
		...
		"sqlite/authority_prune_witness.go",
		"sqlite/authority_recovery_successor.go",
		"sqlite/authority_recovery_successor_extension.go",
		"sqlite/authority_recovery_successor_promotion.go",
		"sqlite/authority_recovery_successor_reader.go",
		"sqlite/authority_recovery_successor_replay.go",
		"sqlite/authority_recovery_terminal_receipt.go",
		"sqlite/authority_recovery_transition.go",
		"sqlite/codec_v1.go",
		...
		"sqlite/legacy_prune_v1.go",
		"sqlite/legacy_scratchpad_v1.go",
		"sqlite/read.go",
		...
		"sqlite/store.go",
		"sqlite/sync.go",
		"sqlite/terminal_candidate.go",
		"sqlite/terminal_candidate_codec.go",
		"sqlite/terminal_candidate_promotion.go",
	...
	wantExports := []string{
		...
		"FactCatalog", "FactCheckpointRecorded", "FactDecisionOpened", "FactDecisionResolved", "FactDecisionSuperseded", "FactDefinition", "FactExplorationStarted", "FactExternalReferenceAttached", "FactExternalReferenceDetached", "FactExternalReferenceRegistered", "FactFindingCorrected", "FactFindingRecorded", "FactFindingRetracted", "FactHandoffRecorded", "FactID", "FactIdeaArchived", "FactIdeaCreated", "FactIdeaPromotedToExternalReference", "FactIdeaResolved", "FactIdeaRevised", "FactJournalCorrectionRecorded", "FactJournalRecorded", "FactKind", "FactProjectLabelRevised", "FactProjectRegistered", "FactSparkCaptured", "FactSparkDismissed", "FactSparkPromotedToIdea", "FactVerificationEvidenceRecorded", "FactWrapRecorded",
		"Mutation", "MutationAppendOnly", "MutationAppendWithAttachmentChanges", "MutationAppendWithCorrectionRetraction", "MutationAppendWithCorrections", "MutationAppendWithDisposition", "MutationAppendWithResolutionSupersession", "MutationAppendWithRevisionDispositionPromotion", "MutationMintOnce", "MutationMintOnceWithLabelRevisions", "MutationReadTimeFold",
		"Permanence", "PermanenceDerived", "PermanenceLedger", "PermanenceNotebook",
		"Projection", "ProjectionActiveSpark", "ProjectionContextDigest", "ProjectionCurrentDecision", "ProjectionCurrentFinding", "ProjectionCurrentIdea", "ProjectionCurrentIdentity", "ProjectionEffectiveTimeline", "ProjectionEvidenceLedger", "ProjectionExplorationIdentity", "ProjectionLatestCheckpoint", "ProjectionLatestHandoff", "ProjectionLatestWrap", "ProjectionReferenceAttachments",
		"ProjectID",
		"RecordCheckpoint", "RecordDecision", "RecordDerivedContext", "RecordExploration", "RecordExternalReference", "RecordFinding", "RecordHandoff", "RecordIdea", "RecordJournalEntry", "RecordKind", "RecordProjectIdentity", "RecordSemantics", "RecordSpark", "RecordVerificationEvidence", "RecordWrap",
		"ReferenceBehavior", "ReferencesEvidenceLeaf", "ReferencesIncludeAttached", "ReferencesMayAttachOpaque", "ReferencesOpaqueLeaf",
		"Retention", "RetentionForever", "RetentionRecomputed",
		"SemanticsFor",
		"SubjectID",
	}
	...
	wantExports = append(wantExports,
		...
		"RecordVersion",
		"Snapshot", "SnapshotRequest", "Spark",
