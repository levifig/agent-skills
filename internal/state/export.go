...
var exportAllTables = []exportTable{
	...
	{Name: "work_contracts", OrderBy: "id", FilterColumn: "project_id"},
	{Name: "work_contract_criteria", OrderBy: "id", FilterColumn: "project_id"},
	{Name: "work_contract_criterion_claims", OrderBy: "id", FilterColumn: "project_id"},
	{Name: "work_contract_workspace", OrderBy: "contract_id", FilterColumn: "project_id"},
	{Name: "work_contract_mappings", OrderBy: "id", FilterColumn: "project_id"},
	{Name: "work_contract_receipts", OrderBy: "id", FilterColumn: "project_id"},
