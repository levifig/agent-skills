...
func TestReleaseApplyResumesPreparedTreeAfterEvidenceRerecord(t *testing.T) {
	...
	wantPaths := []string{
		...
		"docs/changes/20260806-versioning-reset/research/claude-code-2.1.223-plugin-startup-smoke.json",
		"docs/changes/20260806-versioning-reset/research/codex-0.146.0-isolated-startup-smoke.json",
		"docs/changes/20260806-versioning-reset/research/opencode-1.18.13-isolated-request-smoke.json",
		"package.json",
	}
...
func TestReleasePostMergeEvidenceOnlyRepairPasses(t *testing.T) {
	repo := seedReleasePostMergeFiles(t, "1.2.3")
	seedReleaseCapabilityEvidence(t, repo)
	receipt := "docs/changes/20260806-versioning-reset/research/opencode-1.18.13-isolated-request-smoke.json"
