...
func TestReleaseApplyResumesPreparedTreeAfterEvidenceRerecord(t *testing.T) {
	...
	wantPaths := []string{
		...
		"docs/changes/20260802-harness-neutral-skills/research/claude-code-2.1.222-plugin-startup-smoke.json",
		"docs/changes/20260802-harness-neutral-skills/research/codex-0.146.0-isolated-startup-smoke.json",
		"docs/changes/20260802-harness-neutral-skills/research/opencode-1.18.7-isolated-request-smoke.json",
		"package.json",
	}
...
func TestReleasePostMergeEvidenceOnlyRepairPasses(t *testing.T) {
	repo := seedReleasePostMergeFiles(t, "1.2.3")
	seedReleaseCapabilityEvidence(t, repo)
	receipt := "docs/changes/20260802-harness-neutral-skills/research/opencode-1.18.7-isolated-request-smoke.json"
