...
func TestReleaseApplyResumesPreparedTreeAfterEvidenceRerecord(t *testing.T) {
	...
	wantPaths := []string{
		...
		"docs/changes/20260808-hooks-entry-reconciliation/research/claude-code-2.1.226-plugin-startup-smoke.json",
		"docs/changes/20260808-hooks-entry-reconciliation/research/codex-0.147.0-isolated-startup-smoke.json",
		"docs/changes/20260808-hooks-entry-reconciliation/research/opencode-1.18.13-isolated-request-smoke.json",
		"package.json",
	}
...
func TestReleasePostMergeEvidenceOnlyRepairPasses(t *testing.T) {
	repo := seedReleasePostMergeFiles(t, "1.2.3")
	seedReleaseCapabilityEvidence(t, repo)
	receipt := "docs/changes/20260808-hooks-entry-reconciliation/research/opencode-1.18.13-isolated-request-smoke.json"
