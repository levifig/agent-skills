	...
	return []agentHelpCommand{
		...
		},
		{
			...
			Subcommands: []agentHelpSubcommand{
				...
				{Name: "absorb", Description: "Mint an issue from a leftover task or intent, or dismiss the source", Options: []agentHelpOption{{Flags: "--dismiss", Description: "Archive the source as superseded without minting an issue"}, {Flags: "--json", Description: "Output the absorb result, global database scope, and project identity as JSON"}}},
				...
				{Name: "start", Description: "Create a branch and worktree for an issue", Options: []agentHelpOption{{Flags: "--json", Description: "Output the started issue, branch, worktree, base, global database scope, and project identity as JSON"}}},
				{Name: "stop", Description: "Remove an issue worktree and clear the started workspace", Options: []agentHelpOption{{Flags: "--force", Description: "Remove a dirty worktree"}, {Flags: "--json", Description: "Output the stopped issue, branch, worktree, already-gone flag, global database scope, and project identity as JSON"}}},
