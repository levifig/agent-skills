...
- Structured receipt: superseded — later re-records replaced the 2.1.207 receipt in place; retained successors sit beside this narrative ([claude-code-2.1.218-plugin-startup-smoke.json](claude-code-2.1.218-plugin-startup-smoke.json), and the registry-referenced [claude-code-2.1.220-plugin-startup-smoke.json](claude-code-2.1.220-plugin-startup-smoke.json)).
