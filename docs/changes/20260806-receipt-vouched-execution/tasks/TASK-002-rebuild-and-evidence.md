...
- [x] Re-record capability evidence against the rebuilt binary; commit
- [x] Add the `[Unreleased]` changelog line for the gate fix
- [x] After the final flip: run `loaf change verify docs/changes/20260806-receipt-vouched-execution` and land the receipt as the branch's last, content-free commit
