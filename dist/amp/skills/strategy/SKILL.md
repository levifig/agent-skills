...
Strategy discovery requires **extensive interviewing**. Use `Amp UI input` frequently. Ask non-obvious questions about users, competitors, problem space, and domain language.
