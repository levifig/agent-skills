...
description: >-
  Defines the provider-neutral project-management/v1 contract for canonical
  tracker work. Use when a Flow ceremony must read or mutate native work through
  an already-configured harness connection. Not for configuring providers or
