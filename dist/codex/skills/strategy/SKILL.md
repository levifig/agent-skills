...
Strategy discovery requires **extensive interviewing**. Use `request_user_input` frequently. Ask non-obvious questions about users, competitors, problem space, and domain language.
