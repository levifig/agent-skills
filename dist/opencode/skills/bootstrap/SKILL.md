...
Interview depth adapts to the detected mode. All interviews use `prompt the user in chat`. The full interview framework is in [references/interview-guide.md](references/interview-guide.md).
