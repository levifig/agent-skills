...
4. **One question at a time, recommendation-first** — via `prompt the user in chat` (or one inline question per message). Never a multi-field form. Order by impact on the brief. Full mechanics: [references/interview-guide.md](../skills/pitch/references/interview-guide.md).
