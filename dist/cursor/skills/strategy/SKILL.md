...
Strategy discovery requires **extensive interviewing**. Use `built-in chat clarification` frequently. Ask non-obvious questions about users, competitors, problem space, and domain language.
