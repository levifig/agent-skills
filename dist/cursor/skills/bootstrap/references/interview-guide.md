...
2. **Problem states without the others** — a cold reader can name the friction, who has it, the current alternative, and the value for *this* concept alone, without needing sibling folders to make sense of the ask.
...
- Challenge over-splitting: "Can this problem be stated without that one?" If no, merge candidates or leave as BRIEF lines.
