---
name: triage
description: Triages canonical native tracker candidates without creating a local intake queue. Use when deciding which existing records should advance, defer, close, or return to discovery. Produces verified native dispositions and explicit gaps.
---
