...
- `loaf issue absorb` turns leftover open work — a todo, blocked, in_progress, or review task, or an intent — into a fresh issue, or dismisses it, without unfreezing the old write commands. Done and archived tasks stay frozen history. The old alias stays provenance only. Freeze errors now name the 0.5.0 horizon ([#165](https://github.com/levifig/loaf/pull/165)).
