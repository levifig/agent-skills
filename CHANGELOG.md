...
### LOAF-42 — Migrate leftover open work onto issues
- docs: attribute leftover absorb on main to LOAF-42 (735c050d)

### Unattributed
- Leftover absorb, issue identity, and retitle (#165) (4a388ec7)
- Rebuild distribution artifacts for v0.3.0 (b873cb9f)
- Describe the 0.3.0 work-model unification in the changelog (50964150)
