...
- First-class, harness-neutral Linear skill that discovers the project-selected Linear MCP by name, reads before mutating, batches related work, and preserves Loaf issue authority and reconciliation boundaries; bootstrap records only the MCP name, and Loaf never installs, connects, or authenticates it.
