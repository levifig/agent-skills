...
description: >-
  ...
  loose ends, prompts for action on uncommitted/unpushed work, and writes a
  wrap entry to the project journal when there is synthesis worth saving. Use
  at the end of a work session or when the user asks "wrap up." Not for
  archiving (use housekeeping) or capturing ideas (use idea). Produces a
  Session Wrap-Up summary and an optional wrap journal entry.
---
