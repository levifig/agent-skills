...
name: brainstorm
description: >-
  Preserves the structured divergent-thinking stance consumed by the explore workflow: option generation before judgment, trade-off analysis, and spark capture.
  Not a primary entry point — route "explore this", "help me think through options", or similar user entry intent to pitch; explore owns the agent-facing inquiry lifecycle that consumes this technique.
  Not for problem discovery as a ceremony (use pitch) or bounding a chosen direction (use shape).
---
