...
name: orchestration
description: >-
  Coordinates multi-agent work: agent delegation, journal continuity, and council workflows. Use when delegating to agents or coordinating cross-cutting work across multiple agents. Not for single-task implementation (use direct tool delegation) or solo research (use research).
---
