...
description: >-
  ...
  setting up project standards. Covers naming, TDD, verification, and review workflows.
  Not for git workflow (use git-workflow), debugging (use debugging), or security audits (use security-compliance).
---
