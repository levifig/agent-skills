...
- As the first action, emit a private `skill(pitch)` continuity event when the vNext continuity capability is present. Never put invocation bookkeeping in the tracker.
