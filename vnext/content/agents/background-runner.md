...
description: Executes a bounded non-interactive task and returns evidence through the harness, persisting a skill-owned report only when the parent explicitly establishes a need beyond the immediate result.
---
