...
// Validate checks scratchpad opening content.
func (payload ScratchpadOpenedPayload) Validate() error {
	if err := payload.Observation.Validate(); err != nil {
		return err
	}
	if err := validateOptionalReference("focus", payload.Focus); err != nil {
...
// Validate checks scratchpad participant content.
func (payload ScratchpadParticipantPayload) Validate() error {
	if err := payload.Observation.Validate(); err != nil {
		return err
	}
	if err := validateOpaqueID("participant_id", string(payload.ParticipantID), false); err != nil {
		return err
	}
	if err := validateRequiredShort("name", payload.Name); err != nil {
		return err
	}
	return validateOptionalReference("focus", payload.Focus)
}

// Validate checks scratchpad message content.
func (payload ScratchpadMessagePayload) Validate() error {
	if err := payload.Observation.Validate(); err != nil {
		return err
	}
	if err := validateOpaqueID("participant_id", string(payload.ParticipantID), false); err != nil {
...
// Validate checks scratchpad claim content.
func (payload ScratchpadClaimPayload) Validate() error {
	if err := payload.Observation.Validate(); err != nil {
		return err
	}
	if err := validateOpaqueID("claim_id", string(payload.ClaimID), false); err != nil {
		return err
	}
	if err := validateOpaqueID("participant_id", string(payload.ParticipantID), false); err != nil {
		return err
	}
	if err := validateRequiredShort("resource", payload.Resource); err != nil {
		return err
	}
	if payload.ExpiresAtMillis <= payload.Observation.ObservedAtMillis {
		return invalid("expires_at_millis", "must be later than the explicit observation time")
	}
	return nil
}

// Validate checks scratchpad claim release content.
func (payload ScratchpadClaimReleasePayload) Validate() error {
	if err := payload.Observation.Validate(); err != nil {
		return err
	}
	if err := validateOpaqueID("claim_id", string(payload.ClaimID), false); err != nil {
	...
	if err := validateOpaqueID("released_by", string(payload.ReleasedBy), false); err != nil {
		return err
	}
	return validateOptionalProse("reason", payload.Reason, maximumProseBytes)
}

// Validate checks scratchpad close content.
func (payload ScratchpadClosePayload) Validate() error {
	if err := payload.Observation.Validate(); err != nil {
		return err
	}
	if err := validateOpaqueID("closed_by", string(payload.ClosedBy), true); err != nil {
		return err
	}
	return validateOptionalProse("reason", payload.Reason, maximumProseBytes)
}
